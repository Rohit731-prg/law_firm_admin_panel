export const leadsTable = [
    "Image", "Name", "phone", "Create At", "Verified"
];

export const adminTable = [
    "Image", "Name", "Phone", "Email", "Role", "Create At", "Action"
];
...
export const infoListing = [
    "Type", "Name", "Phone", "Pincode", "Address", "State", "District", "Sub Division", "Police Station", "Create At", "Action"
]